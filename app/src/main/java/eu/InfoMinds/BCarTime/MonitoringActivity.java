...
public class MonitoringActivity extends Activity  {
    ...
    public void populateListView () {
        Cursor cursor = database.getTimeAttendance();
        ListViewCursorAdapter lvCursorAdapter = new ListViewCursorAdapter(this,cursor,0);

        ListView listview = findViewById(R.id.listview);
        listview.setAdapter(lvCursorAdapter);
